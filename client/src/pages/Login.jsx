...
// Iconos simples como componentes (podrías usar lucide-react o heroicons)
const MailIcon = () => (
    ...
    useEffect(() => {
        if (error) {
            const timer = setTimeout(() => {
                // El error se limpia después de 5 segundos automáticamente
                setError(null)
            }, 5000)
            ...
            <div className="lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 relative overflow-hidden hidden lg:flex items-center justify-center">
                ...
                <div className="relative z-10 text-white text-center max-w-md mx-auto px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <h1 className="text-4xl font-bold mb-2">ATIENDE</h1>
                        <p className="text-blue-100 text-lg">Gestión de citas médicas</p>
                    </div>
                    ...
                    <div className="space-y-4 text-left">
                        <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-blue-100">Gestiona citas en tiempo real</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                            <div className="w-10 h-10 bg-blue-500/20 rounded-lg flex items-center justify-center">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-blue-100">Admin, doctor, recepción y paciente</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="lg:w-1/2 flex items-center justify-center p-6 bg-gray-50 min-h-screen lg:min-h-0">
                <div className="w-full max-w-md">
                    ...
                    <div className="text-center mb-8 lg:hidden">
                        ...
                        <h1 className="text-2xl font-bold text-gray-800">ATIENDE</h1>
